...
python ESC-50-CODE/code/pytorch/main.py train --dataset_dir=%DATASET_DIR% --workspace=%WORKSPACE% --holdout_fold=5 --model_type=Transfer_Cnn14 --pretrained_checkpoint_path=%PRETRAINED_CHECKPOINT_PATH% --loss_type=clip_nll --augmentation mixup --learning_rate=1e-4 --batch_size=32 --resume_iteration=0 --stop_iteration=4000 --cuda
